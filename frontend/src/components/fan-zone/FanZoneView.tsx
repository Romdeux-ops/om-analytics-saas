...
import type { MessageFeedPage, PollView, RoomView } from "@/src/lib/fan-zone/types";
...
export function FanZoneView({ rooms, initialFeed, defaultSlug }: FanZoneViewProps) {
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <aside className="lg:col-span-2">
          {feed && <PollList key={selectedSlug} polls={feed.polls} />}
        </aside>
      </div>
    </div>
  );
